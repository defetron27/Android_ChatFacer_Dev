...
public class MainActivity extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        prepareThumbnailMasks(masks);
    }

    private void prepareThumbnailMasks(ArrayList<Integer> masks)
    {
        ...
        masksRecyclerView.setLayoutManager(new LinearLayoutManager(MainActivity.this, LinearLayoutManager.HORIZONTAL,false));
        MasksAdapter masksAdapter = new MasksAdapter(MainActivity.this, thumbs);
